...
<html>
    ...
    <body>
	  ...
	  <div id=style>
            <ul>
                  <li><a href="get_death_details.php" id=link>Details</a></li>
                  <li><a href="get_fa_details.php">Funeral Advance</a>
                  <li><a class="active" href="get_kkkosh_details.php">KKKOSH</a></li>
                  <li><a href="get_df_details.php">Disstress Fund</a></li>
            </ul>
        </div>
        <br>
	  <br>
	  <br>
	  <br>
	  <form method="post" action="display_kkkosh_details.php">
		  <fieldset>
