        ...
        <form method="post" action="cga_details.php">
                ...
                <legend><h2>Details:</h2></legend>
                    ...
                    <table align="center" border="0">
                        <tr class="spaceUnder">
                            ...
                            <td><input type="checkbox" name="appwidow" id="appwidow" value="No" onchange="ifChecked(this);"></td>
                        </tr>
                        <tr class="spaceUnder">
                            <td>CGA application received from Candidate: </td>
                            <td><input type="checkbox" name="appcandidate" id="appcandidate" value="No" onchange="showRelation(this);ifChecked(this);"></td>
                        </tr>
			...
			<tr class="spaceUnder">
                        ...
                        <tr class="spaceUnder">
                            ...
                            <td><input name="dropdowndata" id="dropdowndata" type="text"></td>
                        </tr>
                    </table>
                <br><br><br><br>
