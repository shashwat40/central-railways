...
<html>
    ...
    <body>
	  ...
	  <div id=style>
            <ul>
                  <li><a class="active" href="get_death_details.php" id=link>Details</a></li>
                  <li><a href="get_fa_details.php">Funeral Advance</a>
                  <li><a href="get_kkkosh_details.php">KKKOSH</a></li>
	  ...
	  <br>
	  <br>
	  <form method="post" action="display_death_details.php">
		  <fieldset>
