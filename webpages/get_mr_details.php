...
<html>
    ...
    <body>
	  ...
	  <p><a href="<?php session_start(); if($_SESSION['username'] == 'cradmin') {echo 'admin_dashboard.php';} else {echo 'user_dashboard.php';}?>" align="right">Home</a></p>
        ...
        <div id=style>
            <ul>
                <li><a href="get_cga_details.php" id=link>Details</a></li>
                <li><a class="active" href="get_mr_details.php">Minor Registration</a></li>
                <li><a href="get_remark_details.php">Remarks</a></li>
            </ul>
        </div>
        <br>
	  <br>
	  <form method="post" action="display_mr_details.php">
		  <fieldset>
